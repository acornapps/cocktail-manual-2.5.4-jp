...
| 프로토콜 유형 | GIT에서 제공하는 HTTP/HTTPS 프로토콜을 지원 |
| 깃 저장소 유형 | Private/Common을 지원 |
| 리파지토리 URL | 다운로드 하기위한 GIT저장소 URL |
| 리파지토리 User ID | GIT저장소의 권한을 갖는 ID |
| 리파지토리 패스워드 | GIT저장소의 권한을 갖는 ID의 패스워드 |
| 타겟 브랜치 | 다운로드할 소스의 브랜치정보 |
...
| **이미지 빌드** | 설명 |
| :--- | :--- |
| Dockerfile | 이미지를 만들기위한 Dockerfile |
